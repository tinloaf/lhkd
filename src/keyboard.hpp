...
public:
	...
	void add_hotkey(std::string keyname, bool meta, bool alt, bool ctrl,
	                bool shift, bool super, std::string action, int keyboard_id);
	void listen();
...
private:
	...
	void establish_grab(xkb_keysym_t ksym, bool meta, bool alt, bool ctrl,
	...
	size_t mod_profile();
	uint16_t get_xlib_modifiers(bool meta, bool alt, bool ctrl, bool shift,
	                            bool super);
	...
	/* We need to listen to modifiers by keycode, to fix problems
	 * with shifted versions. */
	KeyCode kc_control_l;
	KeyCode kc_control_r;
	KeyCode kc_shift_l;
	KeyCode kc_shift_r;
	KeyCode kc_alt_l;
	KeyCode kc_alt_r;
